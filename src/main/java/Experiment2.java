 ...
 * @author arda.eksi
 */
public class Experiment2 extends ShaderedRenderable {

    
     Camera cam = new Camera();
    private float[] rx = new float[]{0f,0f,0f};
    ...
    private String texturePath = "res/s7.jpg";
    
    @ShaderParameter(Type = String.class, Usage = Usage.textureFilePath)
    private String texturePath2 = "res/s4.jpg";
    ...
    @ShaderParameter(Type = float[].class, Usage = Usage.uniformVariable)
    private float[] lightPos = new float[]{4f, 4f, 4f};
